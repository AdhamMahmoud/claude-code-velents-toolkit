...
> 5. **Migration verification** — always run `php artisan migrate --dry-run` before `migrate`. Verify the table was created with `php artisan tinker --execute="Schema::hasTable('[table_name]');"` after running
